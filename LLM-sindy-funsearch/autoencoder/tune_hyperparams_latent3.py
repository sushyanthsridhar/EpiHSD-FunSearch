...
Results saved to:
  optuna_results_latent3.csv   all trials ranked by val_r2
  best_config_latent3.txt      best configuration found
────────────────────────────────────────────────────────────────
"""
...
res_df.to_csv(os.path.join(HERE, "optuna_results_latent3.csv"), index=False)
print(f"\nAll results saved to optuna_results_latent3.csv")

# ── Best config ────────────────────────────────────────────────
best = study.best_trial
cfg_path = os.path.join(HERE, "best_config_latent3.txt")
...
print(f"\nBest config saved to best_config_latent3.txt")
